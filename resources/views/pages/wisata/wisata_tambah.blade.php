...
@section('content')
  <div class="container" id="content">
    <div class="col-sm-10 offset-sm-1">
      ...
      <form method="post" action="{{url('/wisata')}}" enctype="multipart/form-data">
        @csrf {{-- untuk mencegah serangan csrf --}}

        <div class="form-group row">
          <label for="kode_wisata" class="col-sm-2 col-form-label">Kode Wisata</label>
          <div class="col-sm-10">
            <input type="text" class="form-control" name="kode_wisata" id="kode_wisata" placeholder="Kode Wisata" required>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" name="nama_wisata" id="nama_wisata" placeholder="Nama Tempat Wisata" required>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" name="alamat" id="kode_wisata" placeholder="Alamat.." required>
          </div>
        </div>
